...
class UsersManagementController extends Controller
{
    ...
    /**
     * Method to search the employees.
     *
     * @param  Request  $request
     * @return \Illuminate\Http\Response
     */
    ...
    {
        $searchTerm = $request->input('emp_search_box');
        $searchRules = [
            'emp_search_box' => 'required|string|max:8',
        ];
        $searchMessages = [
            'emp_search_box.required' => 'Search term is required',
            'emp_search_box.string'   => 'Search term has invalid characters',
            'emp_search_box.max'      => 'Search term has too many characters - 8 allowed',
        ];
